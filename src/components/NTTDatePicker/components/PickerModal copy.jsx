...
import { DAYS_OF_WEEK, dateDetails, previousMonth, nextMonth, daysInMonth, firstDayOfMonth, isDaySame, padValue } from '../../../utils/WEDateUtils';
...
const PickerModal = ({ date, handleSelect, handleClose, show, top, left }) => {
  ...
  return (
    <div className={`${styles.picker_modal} ${show ? styles.showing : ""}`} onClick={handleClickOutside}>
      <div ref={modalRef} className={styles.date_picker_modal} style={{ position: "absolute", top: top, left: left }}>
